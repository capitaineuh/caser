...
$cartdb = new CreateDb(dbname: "login_sample_db", tablename: "panier");
    ...
    <div class=\"row row-2\">
        ...
        <div class=\"col-2\">
                <p id=\"Accueil\">Accueil / phone case</p>
                <h1>$productname</h1>
                <h4>$productprice €</h4>
...
<p>Cochez la case pour inclure la coque</p><input type=\"checkbox\">
...
<p>$lib</p>
 ...
 mysqli_close($con);
        ...
        function cartElement($productid, $productname, $productprice, $productimg, $idForm, $idCart){
            $element = "
            <tr>
            <td>
                <div class=\"cart-info\">
                ...
                <input type=\"hidden\" name=\"a_recup\" value=\"$productid\"/>
                    ...
                    <div>
                        ...
                        <input type=\"hidden\" name=\"id_to_delete\" value=\"$idCart\"> 
            ...
            <form action=\"cart.php\" method=\"POST\">
            <td><input type=\"number\" value=\"1\" id=\"qte\" name=\"qte\"></td>
            </form>
            <td>20.00€</td>
        </tr>
    ...
    function bonjour() {
        ...
        if (isset($user_data['user_name']))
          ...
          echo"</div><a href=\"back/logout.php\"> <img src=\"images/icons/logout.png\" class=\"logout\"> </a>";
    }
?>
